...
### Tasks
- [ ] **Task 2.1: Write the Damping Shift Helper**
...
- [ ] **Task 2.2: Integrate into Daily Rescue Evaluator**
...
### Tasks
- [ ] **Task 3.1: Define the Sleep Logging Chat Tool**
...
- [ ] **Task 3.2: Trigger Evaluation Post-Tool Call**
...
### Tasks
- [ ] **Task 4.1: Implement Plan Actions**
...
- [ ] **Task 4.2: Build the Dashboard Banner Component**
...
1. **Typescript Check:** Running `npx tsc --noEmit` must return 100% green.
2. **Unit Tests:** `npm test sleep-plan-log-adaptation` must compile and pass all tests.
3. **Integration Check:** Sign in with a test account. In the Chat tab, say: *"Aria woke up at 6am today."* Verify a sleep log is created, and returning to the dashboard displays the correct dampened schedule banner. Click **[Update Schedule]** and confirm the daily timeline adjusts.
