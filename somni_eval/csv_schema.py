...
ADDITIONAL_OUTPUT_COLUMNS = (
    ...
    "profile_context_seconds",
    "latest_message_age_extraction_seconds",
    "embedding_seconds",
    "retrieval_total_seconds",
    "retrieval_vector_search_seconds",
    "retrieval_rerank_source_selection_seconds",
    "prompt_assembly_seconds",
    "primary_model_call_seconds",
    "primary_model_ttft_seconds",
    "response_validation_filtering_seconds",
    "retry_rewrite_seconds",
    "persistence_database_write_seconds",
